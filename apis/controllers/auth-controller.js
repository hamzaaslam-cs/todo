...
const register = async (req, res, next) => {
  try {
    ...
    return res
      ...
      .send(
        getObjectResponse(true, "User registered successfully", authDto(data))
      );
  } catch (e) {
    next(e);
  }
...
const login = async (req, res, next) => {
  try {
    ...
    return res
      .status(StatusCodes.OK)
      .send(getObjectResponse(true, "Successfully logged in", authDto(data)));
  } catch (e) {
    next(e);
  }
};
...
const forget = async (req, res, next) => {
  try {
    ...
    return res
      .status(StatusCodes.OK)
      .send(
        getObjectResponse(true, "Forget password email send successfully", {})
      );
  } catch (e) {
    next(e);
  }
